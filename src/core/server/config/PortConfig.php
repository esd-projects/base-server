...
class PortConfig
{
     ...
     * @var int
     */
    private $packageBodyOffset;
    /**
     * length长度值在包头的第几个字节。
     * @var int
     */
    private $packageLengthOffset;
    /**
     ...
     * @var bool
     */
    private $enableDelayReceive;

    /**
     * 是否自定义握手
     * @var bool
     */
    private $customHandShake = false;
